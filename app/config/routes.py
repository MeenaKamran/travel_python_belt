...
routes['GET']['/travels/add'] = 'Travels#add'

routes['POST']['/travels/add_trip'] = 'Travels#add_trip'
routes['POST']['/travels/join/<trip_id>'] = 'Travels#join_trip'

routes['GET']['/travels/destination/<trip_id>'] = 'Travels#show_destination'
